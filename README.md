A fork of [reveal.js](http://lab.hakim.se/reveal-js/), modified to use [Redgate's](https://www.red-gate.com/) [fork of highlight.js](https://github.com/red-gate/highlight.js).
